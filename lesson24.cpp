...
bool init() {
    ...
    if(SDL_Init(SDL_INIT_VIDEO) < 0) {
        ...
        w = SDL_CreateWindow("Trabajando con timers: Tercera parte, calculando FPS", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if(w == NULL) {
            cout << SDL_GetError() << endl;
            success = false;
        } else {
...
bool loadMedia() {
    ...
    font = TTF_OpenFont("assets/lesson24/lazy.ttf", 18);
    if(font == NULL) {
